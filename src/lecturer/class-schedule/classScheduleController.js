/**
 * @file HTTP layer for a lecturer's own class-schedule actions (create,
 * list mine, update, delete) — parses the request, calls
 * `classScheduleService.js`, and maps its thrown errors to a status code
 * and JSON body. The student-facing read is
 * `student/class-schedule/classScheduleController.js`.
 */
