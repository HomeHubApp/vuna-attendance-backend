/**
 * @file Lecturer endpoints for running a live class: start, end, list active, list history.
 *
 * @remarks
...
import { startSession, endSession, getActiveSessions, getMySessions } from "./classSessionController.js";
