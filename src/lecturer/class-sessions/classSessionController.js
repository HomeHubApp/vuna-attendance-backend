/**
 * @file HTTP layer for a lecturer running a live class (start, end, active,
 * history) — parses the request, calls `classSessionService.js`, and maps
 * its thrown errors to a status code and JSON body. The student-facing
 * read is `student/class-sessions/classSessionController.js`.
 */
