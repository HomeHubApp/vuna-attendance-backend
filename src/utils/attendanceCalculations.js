// This file contains the logic for computing attendance percentages and
//  trends, given
// the course's class_sessions and session_attendance rows.
//  It is used by both the
// course attendance page and the student attendance page.
//
// It also owns the exam-eligibility rule (minClassesForExam, canStillQualify):
// a student is "at risk" when they can NO LONGER qualify — their attended
// classes plus every class still to come (expected − held) can't reach the
// minimum. Being behind early in the semester is not "at risk"; being unable
// to catch up is.
