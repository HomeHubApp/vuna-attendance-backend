/**
 * @file Student-only routes for a student's own course list and
 * self-service enroll/unenroll. Mounted at `/api/students` by `student/index.js`.
 */
...
import {
  ...
  enrollInCourse,
  unenrollFromCourse,
} from "./studentCourseController.js";
