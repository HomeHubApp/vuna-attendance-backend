/**
 * @file The student's own course list and self-service enroll/unenroll,
 * backed by `GET/POST /api/students/me/courses*`.
 *
 * @remarks
 * Student-only, so it lives beside that role rather than in `shared/`.
 */
