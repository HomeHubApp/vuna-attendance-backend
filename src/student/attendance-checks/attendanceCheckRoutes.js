/**
 * @file Student-only route for submitting a location check-in during a live
 * class. Mounted at `/api/attendance-checks` by `student/index.js`.
 */
import { Router } from "express";
import { rateLimit, ipKeyGenerator } from "express-rate-limit";
import { requireAuth, requireRole } from "../../auth/authMiddleware.js";
import { checkIn } from "./attendanceCheckController.js";
