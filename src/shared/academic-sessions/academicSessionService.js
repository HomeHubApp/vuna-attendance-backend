/**
 * @file The university's academic session (school year) history — CRUD
 * against the `academic_sessions` table.
 *
 * @remarks
 * Lives in `shared/` because both `admin/academic-sessions/academicSessionRoutes.js`
 * (create/update, Admin-only) and `shared/academic-sessions/academicSessionRoutes.js`
 * (list, open to any logged-in user) call into this one service. There is
 * no delete — once created, a session is permanent.
 */
