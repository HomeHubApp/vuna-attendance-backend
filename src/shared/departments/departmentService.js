/**
 * @file Department CRUD against the `departments` table.
 *
 * @remarks
 * Lives in `shared/` because both `admin/departments/departmentRoutes.js`
 * (create/update/delete, Admin-only) and `shared/departments/departmentRoutes.js`
 * (list/get, open to any logged-in user) call into this one service.
 */
