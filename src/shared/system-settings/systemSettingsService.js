/**
 * @file Institution-wide settings: academic year/semester, minimum
 * attendance percentage, expected classes per semester, and the location/
 * Wi-Fi verification toggles.
 *
 * @remarks
 * Lives in `shared/` because both `admin/system-settings/systemSettingsRoutes.js`
 * (`GET /` and `PATCH /`, Admin-only) and `shared/system-settings/systemSettingsRoutes.js`
 * (`GET /current`, open to any logged-in user) call `getSettings` on this
 * one service.
 */
