/**
 * @file Faculty CRUD against the `faculties` table.
 *
 * @remarks
 * Lives in `shared/` because both `admin/faculties/facultyRoutes.js`
 * (create/update/delete, Admin-only) and `shared/faculties/facultyRoutes.js`
