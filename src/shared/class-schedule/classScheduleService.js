/**
 * @file The lecturer's recurring class-schedule feature: creating, listing,
 * updating and deleting `class_schedule` rows, plus deriving a student's
 * own timetable from it.
 *
 * @remarks
 * Lives in `shared/` because both `lecturer/class-schedule/classScheduleRoutes.js`
 * (create/mine/update/delete) and `student/class-schedule/classScheduleRoutes.js`
 * (`getMyScheduleAsStudent`) call into this one service — a recurring class
 * row is the same data whichever role is reading it.
 */
