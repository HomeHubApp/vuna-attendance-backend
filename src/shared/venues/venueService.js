/**
 * @file Venue CRUD against the `venues` table (name, GPS coordinates,
 * radius) — deletion is a soft deactivation, not a row delete.
 *
 * @remarks
 * Lives in `shared/` because both `admin/venues/venueRoutes.js`
 * (create/update/deactivate, Admin-only) and `shared/venues/venueRoutes.js`
 * (list/get, open to any logged-in user — a lecturer picks a venue when
 * scheduling a class) call into this one service.
 */
