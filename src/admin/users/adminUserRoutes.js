/**
 * @file Admin-only user-management routes: list, update, delete a user.
 * Mounted at `/api/admin` by `admin/index.js`.
 */
import * as adminController from "./adminUserController.js";
